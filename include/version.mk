...
VERSION_FORK_REPO:=$(call qstrip,$(CONFIG_VERSION_FORK_REPO))
VERSION_FORK_REPO:=$(if $(VERSION_FORK_REPO),$(VERSION_FORK_REPO),https://haeimalan.github.io/openwrt/ipq50xx-qsdk-kernel-4.4-openwrt-21.02-qsdk-11.4.0.5.7418/%R)
